...
import numpy as np
from osgeo import gdal #added
from rasterio.warp import reproject, Resampling #added
from rasterio.crs import CRS #added
from scipy.ndimage import binary_opening, binary_closing #added
import rasterio
...
def detect_change(pre_path, post_path, output_path):
    with rasterio.open(pre_path) as pre, rasterio.open(post_path) as post:
        ...
        try:
            ...
            aoi_geom = geo_wkt  # geometry is already defined globally
